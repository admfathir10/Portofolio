...
/* ==========================================================================
   TAMBAHAN: MASONRY & HOVER OVERLAY PORTOFOLIO (DI PALING BAWAH)
   ========================================================================== */
...
.portfolio-item:hover img.porto-img,
.portfolio-item:hover .porto-img {
  transform: scale(1.05);
}

/* HOVER OVERLAY JUDUL DI ATAS FOTO/VIDEO */
.portfolio-item .porto-overlay {
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
/* Tampilkan overlay judul saat kursor diarahkan ke gambar */
.portfolio-item:hover .porto-overlay {
  opacity: 1;
  visibility: visible;
}
